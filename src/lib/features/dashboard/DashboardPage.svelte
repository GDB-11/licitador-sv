...
<script lang="ts">
	...
	function handleIniciarProcesoIndividual() {
		goto('/anexos');
	}

	function handleIniciarProcesoConsorcio() {
		goto('/anexos-consorcio');
	}
	...
	<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
		...
		<div class="lg:col-span-2 space-y-8">
			<GenerarDocumentosSection
				onIniciarProcesoIndividual={handleIniciarProcesoIndividual}
				onIniciarProcesoConsorcio={handleIniciarProcesoConsorcio}
			/>
