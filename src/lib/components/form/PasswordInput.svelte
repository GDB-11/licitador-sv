...
<div class="w-full">
	...
	<div class="relative">
		<input
			...
			{oninput}
			{onblur}
			class="w-full px-4 py-2.5 pr-12 border-2 rounded-lg text-gray-900 dark:text-white bg-white dark:bg-gray-700 
		...
		>
			{#if showPassword}
				<EyeOffSvg class="w-5 h-5" />
			{:else}
				<EyeOnSvg class="w-5 h-5" />
			{/if}
		</button>
	</div>
